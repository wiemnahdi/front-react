...
function SignUp() {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            ...
            setIsLoading(false)
            setUser({ firstname: "", lastname: "", email: "", password: "", role: "ADMIN", repeatPassword: "" })
    ...
    return (
                ...
                <Card className='m-auto mt-3 p-2 signup col-lg-8 ' as={Row}>
                    <Form column sm={12} md={8} ld={6} onSubmit={handleFormSubmit}>
                        <h2 className="text-center">Create an User Account</h2>
                        ...
                        <Form.Group as={Row} className="mb-3 mt-3">
                            <Col sm={{ span: 10, offset: 2 }}>
                                <Button variant="primary" type="submit" className="buttn">Add User</Button>
                            </Col>
                        </Form.Group>
...
function SignUp() {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            ...
            console.log(user)
            await axios.post(`${server_uri}/users/register`, { firstname: user.firstname, lastname: user.lastname, email: user.email, password: user.password, role: user.role }
                , {
                    headers: {
                        'Authorization': `Bearer ${currentUser}`,
                        'Content-Type': 'application/json'
